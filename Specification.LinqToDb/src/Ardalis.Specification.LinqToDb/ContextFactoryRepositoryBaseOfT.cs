  ...
  where TContext : IDataContext
{
    ...
    public async Task<TEntity?> GetByIdAsync<TId>(TId id, CancellationToken cancellationToken = default) where TId : notnull
    {
        ...
        return await dbContext.ObjectGetByIdAsync<TEntity, TId>(id, cancellationToken);
    }
    ...
    {
        await using var dbContext = _dbContextFactory.CreateDbContext();
        return await dbContext.GetTable<TEntity>().ToListAsync(cancellationToken);
    }
    ...
    {
        await using var dbContext = _dbContextFactory.CreateDbContext();
        return await dbContext.GetTable<TEntity>().CountAsync(cancellationToken);
    }
    ...
    {
        await using var dbContext = _dbContextFactory.CreateDbContext();
        return await dbContext.GetTable<TEntity>().AnyAsync(cancellationToken);
    }
    ...
    {
        await using var dbContext = _dbContextFactory.CreateDbContext();
        //dbContext.GetTable<TEntity>().Add(entity);
    ...
    {
        await using var dbContext = _dbContextFactory.CreateDbContext();
       // dbContext.GetTable<TEntity>().AddRange(entities);
    ...
    {
        await using var dbContext = _dbContextFactory.CreateDbContext();
        //dbContext.GetTable<TEntity>().Update(entity);
    ...
    {
        await using var dbContext = _dbContextFactory.CreateDbContext();
        //dbContext.GetTable<TEntity>().RemoveRange(entities);
    ...
    {
        return _specificationEvaluator.GetQuery(dbContext.GetTable<TEntity>().AsQueryable(), specification, evaluateCriteriaOnly);
    }
    ...
    {
        return _specificationEvaluator.GetQuery(dbContext.GetTable<TEntity>().AsQueryable(), specification);
    }
}
